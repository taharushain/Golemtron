...
$('document').ready(function() {
	...
	$('#btn-prices-ultimate').click(function(){
		$('#div-prices-container').addClass('animated bounceOutLeft');
		$('#div-prices-container').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
			$('#div-prices-container').hide( 'fast', function() {
				$("#order-type").text("Order Type: Ultimate");
				$("#order-form-type").val("Ultimate");
				$("#div-place-order").show().addClass('animated bounceInRight');
	...
	$(order_form).submit(function(e) {
		...
		.done(function(response) {
			...
			$('#div-place-order').addClass('animated bounceOutLeft').hide( "fast", function() {
				$('#successful-order').show().addClass('animated bounceInRight');
			});
